...
execute "sed -i -e 's|/var/www/ci-blog|/var/www/ci-blog|g' /etc/httpd/conf/httpd.conf" do
  command "sed -i -e 's|/var/www/ci-blog|/var/www/ci-blog|g' /etc/httpd/conf/httpd.conf"
  action :run
end
